...
//자바의 메소드처럼 필요에 따라 인자, 리턴값이 있음.


//1. 함수의 기본형식 : 함수 리터럴로 선언하기(현재 등호의 오른쪽이 함수리터럴임.)
const myfunc1 = function(x) {       //myfunc1 은 함수 리터럴 참조하는 식별자. x는 인자.
...
result = myfunc1(); //인자값이 없음-> 인자 계산못함. 
console.log('result : ' + result);
